    ...
    public function guessFormat(ColumnMap $column)
    {
        ...
        switch ($type) {
            ...
            case PropelTypes::INTEGER:
                return function () {
                    return random_int(0, intval('2147483647'));
                };
            case PropelTypes::BIGINT:
                return function () {
                    return random_int(0, intval('9223372036854775807'));
                };
            case PropelTypes::FLOAT:
                return function () {
                    return random_int(0, intval('2147483647'))/random_int(1, intval('2147483647'));
                };
            case PropelTypes::DOUBLE:
            case PropelTypes::REAL:
                return function () {
                    return random_int(0, intval('9223372036854775807'))/random_int(1, intval('9223372036854775807'));
                };
