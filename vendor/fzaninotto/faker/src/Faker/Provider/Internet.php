...
class Internet extends Base
{
    ...
    public function slug($nbWords = 6, $variableNbWords = true)
    {
        ...
        if ($variableNbWords) {
            $nbWords = (int) ($nbWords * random_int(60, 140) / 100) + 1;
        }
    ...
    {
        return long2ip(random_int(0, 1) == 0 ? random_int(-2147483648, -2) : random_int(16777216, 2147483647));
    }
