...
final class ConfigurationTest extends TestCase
{
    ...
    {
        $tmpFilename = \sys_get_temp_dir() . \DIRECTORY_SEPARATOR . 'phpunit.' . $optionName . \hash('haval128,3',random_int(0, 2147483647)) . '.xml';
    ...
    {
        $tmpFilename = \sys_get_temp_dir() . \DIRECTORY_SEPARATOR . 'phpunit.' . \hash('haval128,3',random_int(0, 2147483647)) . '.xml';
