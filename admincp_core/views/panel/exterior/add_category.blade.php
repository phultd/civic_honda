...
@section('title'){{ __('Add New Ngoại thất Category') }}@endsection

@section('content')

<h4>Add New Ngoại thất Category</h4><br>

<form action="{{ route('admincp.exterior.save.category') }}" method="post">
	@csrf
