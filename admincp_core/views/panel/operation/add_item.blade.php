...
@section('title'){{ __('Add New Vận hành Item') }}@endsection

@section('content')

<h4>Add New Vận hành Item</h4>
...
<form action="{{ route('admincp.operation.save.item',['category'=>Request::route('category')]) }}" method="post">
	@csrf
