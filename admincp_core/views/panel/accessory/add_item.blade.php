...
@section('title'){{ __('Add New Phụ kiện Item') }}@endsection

@section('content')

<h4>Add New Phụ kiện Item</h4>
...
<form action="{{ route('admincp.accessory.save.item',['category'=>Request::route('category')]) }}" method="post">
	@csrf
