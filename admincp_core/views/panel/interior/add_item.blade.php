...
@section('title'){{ __('Add New Nội thất Item') }}@endsection

@section('content')

<h4>Add New Nội thất Item</h4>
...
<form action="{{ route('admincp.interior.save.item',['category'=>Request::route('category')]) }}" method="post">
	@csrf
